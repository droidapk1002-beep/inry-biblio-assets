...
function renderAdminDocTable() {
  ...
  html += `<tr class="selection-toolbar"><td colspan="10" style="padding:0.5rem 1rem;background:var(--surface);border-bottom:1px solid var(--kraft-line);">
    <div style="display:flex;gap:var(--space-2);align-items:center;justify-content:center;flex-wrap:wrap;">
      ...
      <button class="btn btn-secondary btn-xs" id="bulk-edit-btn" style="display:none;">✏️ Modifier</button>
  ...
  html += `<tr class="bulk-edit-row" style="display:none;"><td colspan="10" style="padding:0.75rem 1rem;background:var(--surface);border-bottom:1px solid var(--kraft-line);">
    <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:0.6rem 1rem;align-items:end;">
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-level-cb" onchange="document.getElementById('be-level').disabled=!this.checked"> Niveau
        </label>
        <select id="be-level" disabled style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);"></select>
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-subject-cb" onchange="document.getElementById('be-subject').disabled=!this.checked"> Matière
        </label>
        <select id="be-subject" disabled style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);"></select>
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-type-cb" onchange="document.getElementById('be-type').disabled=!this.checked"> Type
        </label>
        <select id="be-type" disabled style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);"></select>
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-host-cb" onchange="document.getElementById('be-host').disabled=!this.checked"> Hébergeur
        </label>
        <input type="text" id="be-host" disabled placeholder="drive / mega / other" list="be-host-datalist" style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);">
        <datalist id="be-host-datalist">
          <option value="drive">Google Drive</option><option value="mega">Mega</option><option value="other">Autre</option>
        </datalist>
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-trimestre-cb" onchange="document.getElementById('be-trimestre').disabled=!this.checked"> Trimestre
        </label>
        <select id="be-trimestre" disabled style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);"></select>
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-year-cb" onchange="document.getElementById('be-year').disabled=!this.checked"> Année
        </label>
        <input type="number" id="be-year" disabled min="2000" max="2100" style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);">
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-source-cb" onchange="document.getElementById('be-source').disabled=!this.checked"> Source
        </label>
        <input type="text" id="be-source" disabled placeholder="…" style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);">
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-url-source-cb" onchange="document.getElementById('be-url-source').disabled=!this.checked"> URL Source
        </label>
        <input type="url" id="be-url-source" disabled placeholder="https://…" list="be-url-datalist" style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);">
      </div>
      <div style="display:flex;flex-direction:column;gap:2px;">
        <label style="display:flex;align-items:center;gap:var(--space-1);font-size:var(--fs-xs);font-weight:600;cursor:pointer;">
          <input type="checkbox" id="be-url-pdf-cb" onchange="document.getElementById('be-url-pdf').disabled=!this.checked"> URL PDF
        </label>
        <input type="url" id="be-url-pdf" disabled placeholder="https://…" list="be-url-datalist" style="width:100%;padding:6px 8px;border:1px solid var(--kraft);border-radius:var(--radius-sm);background:var(--surface);font-size:var(--fs-sm);">
      </div>
    </div>
    <datalist id="be-url-datalist"></datalist>
    <div style="margin-top:0.6rem;text-align:right;">
      <button class="btn btn-primary btn-sm" id="apply-bulk-edit-btn">✏️ Appliquer la modification</button>
    </div>
  </td></tr>`;

  // Pending section
  if (pendingDocs.length) {
    html += `<tr class="pending-section-header"><td colspan="10" style="padding:0.75rem 1rem;background:var(--gold);color:var(--ink);font-weight:700;">⏳ ${pendingDocs.length} document(s) en attente de validation</td></tr>`;
    pendingDocs.forEach(doc => {
      ...
      html += `
        <tr data-doc-id="${escapeAttr(doc.id)}" style="background:var(--cream);${isHidden ? 'opacity:0.5;' : ''}">
          ...
          <td>—</td>
          <td class="ltr-only">${escapeHTML(String(doc.year || '—'))}</td>
  ...
  function updateSelectionUI() {
    ...
    const beBtn = document.getElementById('bulk-edit-btn');
    if (beBtn) { beBtn.disabled = count === 0; beBtn.style.display = count === 0 ? 'none' : ''; }
  }
  ...
  const bulkEditRow = document.querySelector('.bulk-edit-row');
  const applyBulkBtn = document.getElementById('apply-bulk-edit-btn');

  const beLevel = document.getElementById('be-level');
  const beSubject = document.getElementById('be-subject');
  const beType = document.getElementById('be-type');
  const beTrimestre = document.getElementById('be-trimestre');
  const beHost = document.getElementById('be-host');
  if (beLevel) beLevel.innerHTML = APP.db.levels.map(grp =>
    `<optgroup label="${escapeAttr(localized(grp.name))}">${grp.years.map(y => `<option value="${escapeAttr(y.id)}">${escapeHTML(localized(y.name))}</option>`).join('')}</optgroup>`
  ).join('');
  if (beSubject) beSubject.innerHTML = `<option value="">—</option>` + APP.db.subjects.map(s => `<option value="${escapeAttr(s.id)}">${escapeHTML(localized(s.name))}</option>`).join('');
  if (beType) beType.innerHTML = APP.db.documentTypes.map(ty => `<option value="${escapeAttr(ty.id)}">${escapeHTML(localized(ty.name))}</option>`).join('');
  if (beTrimestre) beTrimestre.innerHTML = `<option value="">—</option>` + (APP.db.trimestres || []).map(tr => `<option value="${escapeAttr(tr.id)}">${escapeHTML(localized(tr.name))}</option>`).join('');

  (function populateBeUrlDatalist() {
    var dl = document.getElementById('be-url-datalist');
    if (!dl) return;
    var urls = new Set();
    (APP.db.documents || []).forEach(function(d) {
      if (d.urlSource) urls.add(d.urlSource);
      if (d.urlPdf) urls.add(d.urlPdf);
      if (d.previewUrl) urls.add(d.previewUrl);
      if (d.downloadUrl) urls.add(d.downloadUrl);
    });
    dl.innerHTML = '';
    urls.forEach(function(u) { var o = document.createElement('option'); o.value = u; dl.appendChild(o); });
  })();

  if (bulkEditBtn) bulkEditBtn.addEventListener('click', () => {
    const count = tbody.querySelectorAll('.doc-select-cb:checked').length;
    if (!count) return;
    bulkEditRow.style.display = bulkEditRow.style.display === 'none' ? '' : 'none';
  });
  ...
  if (applyBulkBtn) applyBulkBtn.addEventListener('click', () => {
    ...
    const updates = {};
    if (document.getElementById('be-level-cb').checked) updates.level = beLevel.value;
    if (document.getElementById('be-subject-cb').checked) updates.subject = beSubject.value || null;
    if (document.getElementById('be-type-cb').checked) updates.type = beType.value;
    if (document.getElementById('be-host-cb').checked) updates.host = beHost.value.trim();
    if (document.getElementById('be-trimestre-cb').checked) updates.trimestre = beTrimestre.value || null;
    if (document.getElementById('be-year-cb').checked) updates.year = parseInt(document.getElementById('be-year').value, 10) || new Date().getFullYear();
    if (document.getElementById('be-source-cb').checked && document.getElementById('be-source').value.trim()) updates.source = document.getElementById('be-source').value.trim();
    if (document.getElementById('be-url-source-cb').checked && document.getElementById('be-url-source').value.trim()) updates.urlSource = document.getElementById('be-url-source').value.trim();
    if (document.getElementById('be-url-pdf-cb').checked && document.getElementById('be-url-pdf').value.trim()) updates.urlPdf = document.getElementById('be-url-pdf').value.trim();
    if (!Object.keys(updates).length) return showToast('Aucun champ sélectionné');
    const ok = window.confirm('Modifier ' + ids.length + ' document(s) ?\n' + Object.keys(updates).join(', '));
    if (!ok) return;
    ids.forEach(id => {
      const local = getLocalDocs();
      const li = local.findIndex(d => d.id === id);
      if (li !== -1) { Object.assign(local[li], updates); saveLocalDocs(local); return; }
      const base = APP.db.documents.find(d => d.id === id);
      if (!base) return;
      const clone = Object.assign({}, base, updates);
      const allLocal = getLocalDocs();
      allLocal.push(clone);
      saveLocalDocs(allLocal);
    });
    applyLocalDocOverrides();
    renderAdminDocTable();
    showToast(ids.length + ' document(s) modifié(s)');
  });
}
...
const INRY_PAT_KEY_NAME = 'inry_pat_key';

async function getOrCreatePatKey() {
  const stored = localStorage.getItem(INRY_PAT_KEY_NAME);
  if (stored) {
  ...
  localStorage.setItem(INRY_PAT_KEY_NAME, btoa(String.fromCharCode(...new Uint8Array(exported))));
  return key;
}

async function encryptPat(pat) {
  if (!pat) return { encryptedPAT: '', patKey: '' };
  const key = await getOrCreatePatKey();
  const iv = crypto.getRandomValues(new Uint8Array(12));
  const enc = new TextEncoder();
  const ciphertext = await crypto.subtle.encrypt({ name: 'AES-GCM', iv }, key, enc.encode(pat));
  return {
    encryptedPAT: btoa(String.fromCharCode(...new Uint8Array(ciphertext))),
    patKey: btoa(String.fromCharCode(...iv))
  };
}
...
async function buildExportObj() {
  ...
  if (ghCfg.pat) {
    try {
      var enc = await encryptPat(ghCfg.pat);
      ghSync.encryptedPAT = enc.encryptedPAT;
      ghSync.patKey = enc.patKey;
    } catch (e) { /* PAT encryption failed, omit from export */ }
  }
  return {
    meta: APP.db.meta,
...
/* ---- GitHub Sync ---- */
const GH_CONFIG_KEY = 'inry_github_sync';
const GH_AUTO_PUSH_KEY = 'inry_github_auto_push';

function getGithubConfig() {
  try {
    var raw = localStorage.getItem(GH_CONFIG_KEY);
    return raw ? JSON.parse(raw) : { pat: '', repo: '', branch: 'main', path: 'data/db.json' };
  } catch { return { pat: '', repo: '', branch: 'main', path: 'data/db.json' }; }
}
...
function getGithubAutoPush() {
  return localStorage.getItem(GH_AUTO_PUSH_KEY) === 'true';
}

function setGithubAutoPush(val) {
  try { localStorage.setItem(GH_AUTO_PUSH_KEY, val ? 'true' : 'false'); } catch {}
}

function githubLog(msg, isError) {
  var el = document.getElementById('github-push-log');
  var status = document.getElementById('github-push-status');
  if (el) {
    el.style.display = 'block';
    var line = document.createElement('div');
    line.style.color = isError ? 'var(--red-stamp)' : 'var(--ink-soft)';
  ...
  if (status) {
    ...
    status.style.color = isError ? 'var(--red-stamp)' : 'var(--green)';
  }
}

async function pushDbToGithub() {
  var cfg = getGithubConfig();
  if (!cfg.pat) { showToast('Token GitHub manquant'); githubLog('Token GitHub manquant', true); return; }
  if (!cfg.repo || !cfg.branch || !cfg.path) { showToast('Config GitHub incomplète'); githubLog('Config GitHub incomplète', true); return; }

  var statusEl = document.getElementById('github-push-status');
  if (statusEl) { statusEl.textContent = '⏳ Push en cours…'; statusEl.style.color = 'var(--ink-soft)'; }
  githubLog('Préparation du push…');

  try {
    applyLocalDocOverrides();
    var exportObj = await buildExportObj();
    ...
    var headers = { 'Authorization': 'token ' + cfg.pat, 'Accept': 'application/vnd.github.v3+json' };

    var existingSha = null;
    var getRes = await fetch(apiUrl + '?ref=' + cfg.branch, { headers: headers });
    if (getRes.ok) {
      var existing = await getRes.json();
      existingSha = existing.sha;
      githubLog('Fichier existant trouvé, SHA: ' + existingSha.substring(0, 8));
    } else if (getRes.status === 404) {
      githubLog('Fichier inexistant, création…');
    } else {
      var errText = await getRes.text();
      githubLog('Erreur lecture: ' + getRes.status + ' ' + errText, true);
      showToast('Erreur lecture GitHub');
      return;
    }

    var body = { message: 'chore(db): update db.json via inry-biblio admin [' + new Date().toISOString().slice(0, 19) + ']', content: encodedContent, branch: cfg.branch };
    if (existingSha) body.sha = existingSha;

    var putRes = await fetch(apiUrl, { method: 'PUT', headers: headers, body: JSON.stringify(body) });
    if (putRes.ok) {
      var result = await putRes.json();
      githubLog('Push réussi ! Commit: ' + (result.commit?.sha || '').substring(0, 8));
      showToast('db.json poussé sur GitHub ✓');
      saveDbBackup('github-push', exportObj);
      renderDbBackupList();
    } else {
      var errBody = await putRes.text();
      githubLog('Erreur push: ' + putRes.status + ' ' + errBody, true);
      showToast('Erreur push GitHub');
    }
  } catch (err) {
    githubLog('Erreur réseau: ' + err.message, true);
    showToast('Erreur: ' + err.message);
  }
}

function wireGithubSync() {
  var patInput = document.getElementById('github-pat-input');
  var repoInput = document.getElementById('github-repo-input');
  var branchInput = document.getElementById('github-branch-input');
  var pathInput = document.getElementById('github-path-input');
  var pushBtn = document.getElementById('github-push-btn');
  var saveCfgBtn = document.getElementById('github-save-config-btn');
  var autoPushCheck = document.getElementById('github-auto-push');

  var cfg = getGithubConfig();
  if (patInput) patInput.value = cfg.pat || '';
  if (repoInput) repoInput.value = cfg.repo || '';
  if (branchInput) branchInput.value = cfg.branch || 'main';
  if (pathInput) pathInput.value = cfg.path || 'data/db.json';
  if (autoPushCheck) autoPushCheck.checked = getGithubAutoPush();

  if (saveCfgBtn) {
    saveCfgBtn.addEventListener('click', function() {
      var newCfg = {
        pat: patInput ? patInput.value.trim() : '',
        repo: repoInput ? repoInput.value.trim() : '',
        branch: branchInput ? branchInput.value.trim() : 'main',
        path: pathInput ? pathInput.value.trim() : 'data/db.json'
      };
      saveGithubConfig(newCfg);
      showToast('Config GitHub sauvegardée');
      githubLog('Config sauvegardée');
    });
  }
  ...
  if (pushBtn) {
    pushBtn.addEventListener('click', function() {
      ...
      cfg2.pat = patInput ? patInput.value.trim() : cfg2.pat;
      cfg2.repo = repoInput ? repoInput.value.trim() : cfg2.repo;
      cfg2.branch = branchInput ? branchInput.value.trim() : cfg2.branch;
      cfg2.path = pathInput ? pathInput.value.trim() : cfg2.path;
  ...
  if (autoPushCheck) {
    autoPushCheck.addEventListener('change', function() {
      setGithubAutoPush(autoPushCheck.checked);
      showToast(autoPushCheck.checked ? 'Auto-push activé' : 'Auto-push désactivé');
    });
  }
}

var _autoPushTimer = null;
function scheduleAutoPush() {
  if (!getGithubAutoPush()) return;
  if (_autoPushTimer) clearTimeout(_autoPushTimer);
  _autoPushTimer = setTimeout(function() {
    var cfg = getGithubConfig();
    if (cfg.pat) pushDbToGithub();
  }, 2000);
}
...
/* ============================================================
   EXPORT MANIFEST — download or copy to clipboard
   ============================================================ */
function getManifestDocuments() {
  return getLocalDocs().map(d => { const c = Object.assign({}, d); if (c.title && typeof c.title === 'object') c.title = c.title.fr || c.title.ar || c.title.en || ''; if (c.description && typeof c.description === 'object') c.description = c.description.fr || c.description.ar || c.description.en || ''; return c; });
}
function generateManifestJSON() { return { meta: { project: 'inry-biblio', generatedAt: new Date().toISOString(), docCount: getManifestDocuments().length }, documents: getManifestDocuments() }; }
function downloadManifestJSON() { const m = generateManifestJSON(); const b = new Blob([JSON.stringify(m, null, 2)], { type: 'application/json' }); const a = document.createElement('a'); a.href = URL.createObjectURL(b); a.download = 'manifest-inry-' + Date.now() + '.json'; a.click(); showToast('Manifest téléchargé.'); }
function copyManifestToClipboard() { navigator.clipboard.writeText(JSON.stringify(generateManifestJSON(), null, 2)).then(() => { showToast('Manifest copié.'); }).catch(() => { showToast('Erreur copie.'); }); }
function wireExportManifest() { const e = document.getElementById('export-manifest-btn'); const c = document.getElementById('copy-manifest-btn'); if (e) e.addEventListener('click', downloadManifestJSON); if (c) c.addEventListener('click', copyManifestToClipboard); }
